...
namespace GXPEngine
{
	public class Ball : Canvas
	{
		...
		public Ball (int pRadius,string debugLetter ,Vec2 pPosition = null, Vec2 pVelocity = null, Color? pColor = null):base (pRadius*2, pRadius*2)
		{
			radius = pRadius;
			SetOrigin (radius, radius);

            TextField TF = TextField.CreateTextField(debugLetter);
            AddChild(TF);
